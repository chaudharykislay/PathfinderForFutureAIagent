import { V as reactExports, H as isPromise, I as isRedirect, G as isNotFound, B as invariant, g as createControlledPromise, a1 as rootRouteId, J as isServer$1, v as functionalUpdate$1, b as arraysEqual, h as createLRUCache, e as compileDecodeCharMap, a3 as trimPath, a0 as rewriteBasepath, f as composeRewrites, U as processRouteTree, S as processRouteMasks, $ as resolvePath, d as cleanPath, a5 as trimPathRight, Q as parseHref, q as executeRewriteInput, C as isDangerousProtocol, W as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, A as interpolatePath, P as nullReplaceEqualDeep, Y as replaceEqualDeep$1, M as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, z as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a4 as trimPathLeft, K as joinPaths, a7 as useRouter, m as dummyMatchContext, N as matchContext, Z as requireReactDom, p as exactPathTest, X as removeTrailingSlash, R as React, L as jsxRuntimeExports, F as isModuleNotFoundError, a6 as useHydrated, o as escapeHtml, E as isInlinableStylesheet, w as getAssetCrossOrigin, _ as resolveManifestAssetLink, O as Outlet } from "./server-BmciEhQe.js";
import { e as createLovableAiGatewayProvider, D as DEFAULT_MODEL, s as streamText, d as convertToModelMessages, P as PATHFINDER_SYSTEM_PROMPT } from "./ai-gateway-Bq6qT6aC.js";
...
const appCss = "/assets/styles-B_phr7ml.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Not a quiz. Not a test. A real conversation about your future. Personalized AI-powered career roadmaps for students." },
...
const $$splitComponentImporter = () => import("./index-BJdwlb78.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Not a quiz. Not a test. A real conversation about your future — personalized career roadmaps for students by an AI mentor."
    }, {
      property: "og:title",
      content: "PathfinderAI — Your Career Intelligence Agent"
    }, {
      property: "og:description",
      content: "A personalized AI mentor that builds your career roadmap."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const Route2 = createFileRoute("/api/chat")({
  server: {
    handlers: {
      POST: async ({ request }) => {
...
const ApiChatRoute = Route2.update({
  id: "/api/chat",
  path: "/api/chat",
  getParentRoute: () => Route$2
});
